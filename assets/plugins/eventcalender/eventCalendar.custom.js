...
$.fn.eventCalendar = function (e) {
    ...
    function a(e, t, a) {
        ...
        console.log("jjjjjjjjjjjjjjjjjjjjjj" + date);
                            ...
                            if (parseInt(m) <= 9 && (m = "0" + parseInt(m)), (0 === a || a > c) && !(s !== !1 && s != h || "" != r && r != f || "" != n && n != u)) {
                                ...
                                d.push(`<li id="${e}" class="${t.type}">
                                    ...
                                    <div class="price d-flex justify-content-between align-items-end">
                                        <div class="cart-wrap d-flex align-items-center cart_${t.obj_id}" data-cart="cart_${t.obj_id}">
                                            <span><img src="${SITEURL}/assets/web/images/cart-btn-wht.png" alt="Add to Cart Icons"/></span> 
                                            ${g}
                                        </div>
                                    </div>
                                </li>`);
